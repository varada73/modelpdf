...
def rank_sections_and_extract_subsections(
    ...
    for rank, section_info in enumerate(sections_to_process): # Iterate over the filtered list
        ...
        final_extracted_sections.append({
            ...
            "page_number": section_info['page_num_start'], # CHANGED: Renamed 'page_num_start' to 'page_number'
        ...
        if best_block_info:
            ...
            refined_text_entry = {
                ...
                "page_number": refined_text_page # CHANGED: Renamed 'refined_text_page' to 'page_number'
            }
...
def main_round1b_processing(input_dir, output_dir, input_json_path):
    ...
    output_data = {
        "metadata": {
            ...
            # "document_details_from_r1a": all_document_metadata # REMOVED: This field is not in the desired output format
        },
